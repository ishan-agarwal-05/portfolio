...
export const fitSkills: FitSkill[] = [
  ...
  { name: "Flask / REST APIs", aliases: ["flask", "rest", "api design", "microservice", "microservices", "backend"], level: "professional", evidence: "Three deployed microservices at TechFour: auth/OTP, documents, communications.", href: "/#experience" },
  { name: "Flutter", aliases: ["flutter", "mobile"], level: "professional", evidence: "Shipped the Flutter client at TechFour.", href: "/#experience" },
  ...
  { name: "LLM / RAG systems", aliases: ["llm", "rag", "retrieval-augmented", "retrieval augmented", "langchain", "generative ai", "genai", "gen ai", "prompt"], level: "professional", evidence: "RAG assistant over several hundred documents at PwC — LangChain, LangSmith tracing and offline evaluation.", href: "/#experience" },
  ...
  { name: "Salesforce / Apex", aliases: ["salesforce", "apex", "crm"], level: "professional", evidence: "HR recruiting app at Quadrafort; certified Administrator and Developer.", href: "/#experience" },
