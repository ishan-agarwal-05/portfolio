...
export function buildAgentSystemPrompt(): string {
  ...
  const articles = caseStudies
    .map(
      (c) =>
        `- [${c.kind}] ${c.title}, at /work/${c.slug} (${c.org}, ${c.period}): ${c.oneLiner} Key numbers: ${c.metrics
